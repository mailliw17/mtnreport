<div class="container mt-3">
    ...
    <form action="" method="POST">
        ...
        <input type="hidden" class="form-control" id="id_laporan" name="id_laporan" value="<?= $laporan['id_laporan']; ?>">


        <div class="form-group">
            <label for="exampleInputEmail1">Shift</label>
            <select class="form-control" id="shift" name="shift" value="<?= $laporan['shift']; ?>" required>
                <option value="<?= $laporan['shift']; ?>" hidden><?= $laporan['shift']; ?></option>
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="type_wo" name="type_wo" value="<?= $laporan['type_wo']; ?>" required>
                <option value="<?= $laporan['type_wo']; ?>" hidden><?= $laporan['type_wo']; ?></option>
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="group" name="group" required>
                <option value="<?= $laporan['grup']; ?>" hidden><?= $laporan['grup']; ?></option>
        ...
        <div class="form-group">
            ...
            <input list="area_dropdown" class="form-control" id="area" name="area" value="<?= $laporan['area']; ?>" autocomplete="off" required>
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="pekerjaan" name="pekerjaan" rows="3" required><?= $laporan['pekerjaan']; ?></textarea>
        </div>

        <div class="form-group">
            <label for="exampleFormControlTextarea1">Analisis Masalah</label>
            <textarea class="form-control" id="analisis" name="analisis" rows="3" required><?= $laporan['analisis']; ?></textarea>
        </div>

        <div class="form-group">
            <label for="exampleFormControlInput1">Sparepart</label>
            <input type="text" class="form-control" id="sparepart" name="sparepart" autocomplete="off" value="<?= $laporan['sparepart']; ?>" required>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="time" class="form-control" id="jam_selesai" name="jam_selesai" value="<?= $laporan['jam_selesai']; ?>" value="now" required>
            </div>

            <div class="form-group col-md-6">
                <label for="inputPassword4">Durasi</label>
                <input type="text" class="form-control" id="durasi" name="durasi" value="<?= $laporan['durasi']; ?>" readonly>
            </div>

            <div class="form-group col-md-6">
                <label for="inputPassword4">Total Person</label>
                <input type="number" class="form-control" id="total_person" name="total_person" value="<?= $laporan['total_person']; ?>" required>
            </div>

            <div class="form-group col-md-6">
                <label for="inputPassword4">Nama Teknisi</label>
                <input type="text" class="form-control" id="nama_teknisi" name="nama_teknisi" value="<?= $laporan['nama_teknisi']; ?>" autocomplete="off" required>
            </div>

            <div class="form-group col-md-6">
                <label for="exampleInputEmail1">Status Pekerjaan</label>
                <select class="form-control" id="status" name="status" value="<?= $laporan['status']; ?>" required>
                    <option value="<?= $laporan['status']; ?>" hidden><?= $laporan['status']; ?></option>
    ...
    <a href="<?= base_url() ?>admin" class="btn btn-danger btn-block mb-4">Batal</a>
</div>
